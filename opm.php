...
if(isset($_GET['stampa'])){
    ...
    $query = "SELECT * FROM commento_one_pounch_man";
...
if(isset($_GET['cancella1'])){
    ...
    $query = "DELETE FROM commento_one_pounch_man where commento = '$commento'";
    $res = mysqli_query($conn, $query);
    if ($res) {
...
if(isset($_GET['commento'])){
    ...
    $query = "SELECT * FROM commento_one_pounch_man";
    $insertQuery = "INSERT INTO commento_one_pounch_man (utente,commento,data) VALUES (\"$utente\",\"$commento\",CURDATE())";
...
<head>
    ...
    <link rel="stylesheet" href="opm.css?ts=<?=time()?>&quot"/>
    <script src="salva_commento_opm.js" defer="true"></script>
    <meta name="viewport" content="width=device-width, initial-scale=1">
</head>

<body class="demon_slayer">
    <header>
    <nav>
