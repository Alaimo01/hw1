...
if(isset($_GET['stampa'])){
    ...
    $query = "SELECT * FROM commento_dragonball";
...
if(isset($_GET['cancella1'])){
    ...
    $query = "DELETE FROM commento_dragonball where commento = '$commento'";
    $res = mysqli_query($conn, $query);
    if ($res) {
...
if(isset($_GET['commento'])){
    ...
    $query = "SELECT * FROM commento_dragonball";
    $insertQuery = "INSERT INTO commento_dragonball (utente,commento,data) VALUES (\"$utente\",\"$commento\",CURDATE())";
...
<head>
    ...
    <link rel="stylesheet" href="dragonball.css?ts=<?=time()?>&quot"/>
    <script src="salva_commento_dragonball.js" defer="true"></script>
    <meta name="viewport" content="width=device-width, initial-scale=1">
</head>

<body class="dragonball">
    <header>
    <nav>
